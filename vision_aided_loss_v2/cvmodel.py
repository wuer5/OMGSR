...
from vision_aided_loss_v2.DiffAugment_pytorch import DiffAugment
...
class CVBackbone(torch.nn.Module):
    ...
    def __init__(self, cv_type, output_type, diffaug=False, device='cpu'):
        ...
        self.class_name_dict = {
                'seg_ade': 'vision_aided_loss_v2.swintaskspecific.Swin',
                'det_coco': 'vision_aided_loss_v2.swintaskspecific.Swin',
                'clip': 'vision_aided_loss_v2.cvmodel.CLIP',
                'dino': 'vision_aided_loss_v2.cvmodel.DINO',
                'dinov2': 'vision_aided_loss_v2.cvmodel.DINOv2',  # add here for DINOv2
                'vgg': 'vision_aided_loss_v2.cvmodel.Vgg',
                'swin': 'vision_aided_loss_v2.cvmodel.Swin',
                'face_seg': 'vision_aided_loss_v2.face_parsing.Parsing',
                'face_normals': 'vision_aided_loss_v2.face_normals.Normals'
            }
