...
import warnings
from dataloader.my_dataset import PairedDataset
...
def main():
    ...
    # dinov2 gan
    import vision_aided_loss_v2
    net_disc = vision_aided_loss_v2.Discriminator(
        cv_type="dinov2",
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(*[lora_vae, unet, net_disc]):
                ...
                loss_ldr = F.mse_loss(pretrained_noisy_latent, lq_latent, reduction="mean") * args.lambda_ldr
