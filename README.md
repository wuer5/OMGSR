...
## :boom: News
- **2025.9.15**: :boom: **Release the most powerful version (turbo version): `DINOv3-Convnext DISTS loss` and `DINOv3-Vit Discriminator`. Both support 1K-resolution GAN training. Please switch to the `turbo` branch. The latest weight will release in these days!**
