...
## :boom: News
- **2025.9.15**: :boom: **Release the most powerful version: `DINOv3-Convnext DISTS loss` and `DINOv3-Vit Discriminator`. Both support 1K-resolution GAN training. The latest weight will release in these days!**
