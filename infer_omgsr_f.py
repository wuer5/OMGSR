...
from inference.wavelet_color_fix import adain_color_fix, wavelet_color_fix
import glob
from inference.omgsr_f_infer_model import OMGSR_F_Infer
...
def main(args):
    ...
    for image_name in tqdm(image_names):
        ...
        with torch.no_grad():
            ...
            output_image = omgsr(lq_img.to(), prompt_embeds, pooled_prompt_embeds, text_ids, latent_image_ids, args.tile_size, args.tile_overlap)
