...
# class OCEADISTSLoss2(nn.Module):
#     def __init__(self, device):
#         super(OCEADISTSLoss2, self).__init__()    
...
# A = OCEADISTSLoss("cuda")
# B = OCEADISTSLoss2("cuda")
# for i in range(10):
#     x = torch.randn(1, 3,224,224).to("cuda")
#     y = torch.randn(1, 3,224,224).to("cuda")
#     z1 = A(x, y)
#     z2 = B(x, y)
#     print(torch.nn.functional.mse_loss(z1, z2))